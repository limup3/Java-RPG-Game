...
public class 메인연습본 {
	...
	System.out.println("");
			...
			else if(Num4_1 ==2) // 상점
			{
				...
				System.out.println("어떤 상품을 사시겠습니까?");
				System.out.println("1. 아이언소드 / 2. 실버소드 / 3. 골드소드 / 4. 다이아소드");
				int Num4_2 = scan.nextInt(); //스캐너 입력
				if(Num4_2 == 1 )
				{
			...
			else if (Num4_1 ==4) //시험의 탑
			{
				System.out.println("시험의 탑 다음층으로 갑니다.");
				System.out.println("던전을 가기 전 모든 준비는 마치셨나요?");
				System.out.println("1. 예 / 2. 아니오");
				
				int Num4_2 = scan.nextInt();
				if(Num4_2 ==1)
				{
					System.out.println("알겠습니다. 시험의탑으로 이동하겠습니다.");
					break;
			...
			else if(Num5_1 ==2) // 상점
			{
				...
				System.out.println("어떤 상품을 사시겠습니까?");
				System.out.println("1. 아이언소드 / 2. 실버소드 / 3. 골드소드 / 4. 다이아소드");
				int Num5_2 = scan.nextInt(); //스캐너 입력
				if(Num5_2 == 1 )
				{
			...
			else if (Num5_1 ==4) //시험의 탑
			{
				System.out.println("시험의 탑 다음층으로 갑니다.");
				System.out.println("던전을 가기 전 모든 준비는 마치셨나요?");
				System.out.println("1. 예 / 2. 아니오");
				
				int Num5_2 = scan.nextInt();
				if(Num5_2 ==1)
				{
					System.out.println("알겠습니다. 시험의탑으로 이동하겠습니다.");
					break;
